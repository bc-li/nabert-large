{
    ...
    "vocabulary": {
        ...
        "pretrained_files": {
            "tokens": "/data/bochengli/drop-bert/drop_bert/data/glove.840B.300d.lower.converted.zip"
        },
    ...
    "model": {
        ...
        "text_field_embedder": {
            "token_embedders": {
                "tokens": {
                    "type": "embedding",
                    "pretrained_file": "/data/bochengli/drop-bert/drop_bert/data/glove.840B.300d.lower.converted.zip",
                    "embedding_dim": 300,
                    "trainable": false
                },
                "token_characters": {
